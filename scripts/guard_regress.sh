...
[[ -f artifacts/summary/judgement.tsv ]] || { echo -e "OK\tbootstrap" > artifacts/summary/judgement.tsv; }
...
thr=float("${THRESHOLD_PP_2}"); d=float("${DELTA}")
